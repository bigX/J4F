...
public class PreferenceConstants {
	...
	// 公司演示地址
	// public static final String GMAIL_SERVER = "zs.hoolian.cn";
	// public static final String BASE_URL = "http://zs.hoolian.cn:8090/apiv2";
	// public static final String BASE_IMG_URL = "http://zs.hoolian.cn:8087";

	// 公司海淀演示地址
	public static final String GMAIL_SERVER = "zs.hoolian.cn";
	public static final String BASE_URL = "http://smilecity.cn:8901";
	public static final String BASE_IMG_URL = "http://weike.bjcjl.net:8087";

	// 陈经纶正式地址
	// public static final String BASE_URL = "http://58.132.20.63:8089/apiv2";
	// public static final String BASE_IMG_URL = "http://58.132.20.63:8087";
	// public static final String GMAIL_SERVER = "58.132.20.63";

	// 陈经纶测试地址
	// public static final String BASE_URL = "http://58.132.20.63:8090/apiv2";
	// public static final String BASE_IMG_URL = "http://58.132.20.63:8087";
	// public static final String GMAIL_SERVER = "58.132.20.63";
